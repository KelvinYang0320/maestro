...
if __name__ == "__main__":
    ...
    parser.add_argument('--api_name', type=str,
                        default="pytorch", help="api choices: pytorch, keras")
    parser.add_argument('--input_size', type=str,
                        default="3,224,224", help='input size')
    ...
    parser.add_argument('--custom', type=str, default="none",
                        ...
                        'which returns the model. Also put this file in keras_example or torch_example\n')

    parser.add_argument('--outfile', type=str,
                        default="dnn_model.m", help='output file name')
    ...
    if(opt.api_name == 'pytorch'):
        ...
        if opt.model == 'custom':
            ...
            module_name = 'torch-example.' + opt.custom
            new_module = __import__(module_name, fromlist=[opt.custom])
            model = getattr(new_module, opt.custom)()
